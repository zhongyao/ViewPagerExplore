 ...
 */
public class ViewPagerPhotosActivity extends AppCompatActivity implements STPhotoSaveCallBack {
    ...
    private static final String TAG = ViewPagerPhotosActivity.class.getSimpleName();
    ...
    private class TextOnClickListener implements OnClickListener {
        ...
        public void onClick(View v) {
            ...
            if (mCurrentPosition != 3) {
                ImageUtil.saveBmp2Gallery(ViewPagerPhotosActivity.this, ImageUtil.drawableToBitmap(((ImageView) mViewLists.get(
                        mCurrentPosition))
                        .getDrawable()), String.valueOf(DataUtil.getImageResource()[mCurrentPosition]), ViewPagerPhotosActivity.this);
            } else {
                ImageUtil.saveGif2Gallery(ViewPagerPhotosActivity.this, ImageUtil.drawableToBitmap(((ImageView) mViewLists.get(
                        mCurrentPosition))
                                .getDrawable()), ((CustomPhotoView) mViewLists.get(mCurrentPosition)).getBytes(),
                        String.valueOf(DataUtil.getImageResource()[mCurrentPosition]), ViewPagerPhotosActivity.this);
            }
        }
    }
    ...
    private class PhotoOnLongClickListener implements OnLongClickListener {
        ...
        public boolean onLongClick(View v) {
            ToastUtil.showToast(ViewPagerPhotosActivity.this, "长按事件");
            return true;
        }
    }
    ...
    private class PhotoOnViewTapListener implements OnViewTapListener {
        ...
        public void onViewTap(View view, float x, float y) {
            ToastUtil.showToast(ViewPagerPhotosActivity.this, "单击事件，点击图片之外区域也会触发");
            finish();
        }
    }
...
//            finish();
    ...
    private void initDeviceInfo(ViewPagerPhotosActivity activity) {
        /**
         * 双击大长图没有撑满屏幕问题总结：
